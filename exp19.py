# run_gpt2_xl_exp_22.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 18)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 22 - Variation 18, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 56,           # New value for epochs
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 38, # Increased to 38 (effective batch size 1*38=38)
