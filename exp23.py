# run_gpt2_xl_exp_26.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 22)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 26 - Variation 22, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 84,           # Increased to 84 for very long runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 8, # Set to 8 (effective batch size 1*8=8)
