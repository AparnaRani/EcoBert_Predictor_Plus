# run_gpt2_xl_exp_23.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 19)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 23 - Variation 19, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 82,           # Increased to 82 for very long runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 10, # Set to 10 (effective batch size 1*10=10)
