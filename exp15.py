# run_gpt2_xl_exp_18.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 14)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 18 - Variation 14, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 66,           # New value for epochs
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 24, # Set to 24 (effective batch size 1*24=24)
