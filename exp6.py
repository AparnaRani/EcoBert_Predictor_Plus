# run_gpt2_xl_exp_8.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 4)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 8 - Variation 4, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 65,           # Increased from 60 (exp_6) to 65 for longer runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 18, # Adjusted from 28 (exp_7) to 18 (effective batch size 1*18=18)
