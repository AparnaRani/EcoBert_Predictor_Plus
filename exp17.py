# run_gpt2_xl_exp_20.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 16)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 20 - Variation 16, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 54,           # New value for epochs
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 40, # Increased to 40 (effective batch size 1*40=40)
