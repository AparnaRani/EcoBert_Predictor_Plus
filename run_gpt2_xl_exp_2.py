# run_gpt2_xl_exp_2.py (Completely separate script for a new, simultaneous experiment)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 2) ---
    # This configuration is distinct from the one in your first running experiment.
    current_experiment_params = {
        ...
        # Changed: Smaller dataset, fewer epochs, same batch size, no accumulation
        'num_train_samples': 10000,         # Smaller dataset size
        'num_epochs': 3,                    # Fewer training epochs
