# run_gpt2_xl_exp_6.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 2)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 6 - Variation 2, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 60,           # Increased from 50 (exp_4) to 60 for longer runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 20, # Increased from 16 (exp_4) to 20 (effective batch size 1*20=20)
