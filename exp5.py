# run_gpt2_xl_exp_7.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 3)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 7 - Variation 3, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 55,           # Adjusted from 60 (exp_6) to 55 for varied runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 28, # Increased from 20 (exp_6) to 28 (effective batch size 1*28=28)
