# run_gpt2_xl_exp_9.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 5)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 9 - Variation 5, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 70,           # Increased from 65 (exp_8) to 70 for very long runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 22, # Adjusted from 18 (exp_8) to 22 (effective batch size 1*22=22)
