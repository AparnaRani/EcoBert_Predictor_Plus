# run_gpt2_xl_exp_17.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 13)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 17 - Variation 13, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 74,           # Increased to 74 for very long runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 12, # Set to 12 (effective batch size 1*12=12)
