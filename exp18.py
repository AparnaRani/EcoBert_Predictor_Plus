# run_gpt2_xl_exp_21.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 17)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 21 - Variation 17, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 76,           # Increased to 76 for very long runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 16, # Set to 16 (effective batch size 1*16=16)
