# run_gpt2_xl_exp_11.py (GPT2-XL for MAXIMIZED HIGH EMISSIONS within P100/16GB constraints - Variation 7)
import os
import uuid
import pandas as pd
import torch
...
if __name__ == '__main__':
    # --- PARAMETERS FOR THIS SPECIFIC GPT-2 XL RUN (Experiment 11 - Variation 7, Higher Emissions) ---
    ...
    current_experiment_params = {
        ...
        'num_epochs': 80,           # Increased significantly to 80 for maximum possible runtime
        'batch_size': 1,            # Remains at 1, essential for memory
        'gradient_accumulation_steps': 16, # Back to 16, combined with many more epochs
